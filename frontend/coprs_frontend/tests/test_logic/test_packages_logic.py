...
class TestPackagesLogic(CoprsTestCase):
    ...
    def test_successful_build_chroots(self, f_users, f_fork_prepare, f_build_few_chroots):
    ...
    def test_successful_build_chroots_all_builds(self, f_users, f_fork_prepare, f_build_few_chroots):
